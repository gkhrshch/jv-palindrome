...
public class Palindrome {
    ...
    /**
     * <p>Реализуйте метод, проверяющий, является ли заданная строка палиндромом. Палиндромом назы-
     * вается строка, которая читается одинаково слева направо и справа налево (в том числе пустая).
    ...
    public boolean isPalindrome(String text) {
        String toCheck = text.toLowerCase().replaceAll("[^0-9a-z]", "");
        StringBuilder toReverse = new StringBuilder(toCheck);
        return toCheck.equals(toReverse.reverse().toString());
    }
}
